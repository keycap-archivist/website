...
const Modal = (props) => (
  <>
    <div
      className="modal opacity-100 ease-out justify-center items-center
    ...
    >
      <div className="relative w-auto my-6 mx-auto max-w-3xl">
        <div
          className="
            opacity-0 transition-opacity opacity-100 ease-out border-0 rounded-lg shadow-lg relative
            flex flex-col w-full bg-white outline-none focus:outline-none"
        >
          <div className="flex items-start justify-between p-5 border-b border-solid border-gray-300 rounded-t">
            <h3 className="text-2xl font-semibold text-black">{props.modalHeader}</h3>
            <button
            ...
            >
              <span className="bg-transparent text-blue h-6 w-6 text-2xl block outline-none focus:outline-none">×</span>
            </button>
          </div>
